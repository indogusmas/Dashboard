<div class="header">
    ...
    {{-- <div class="top-nav-search" style="visibility: gone">
        <form>
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow new-user-menus">
            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                <span class="user-img">
                    <img class="rounded-circle" src="{{asset('img/profiles/avatar-19.png')}}" width="31"
                        alt="Soeng Souy">
                    <div class="user-text">
                        <h6>User</h6>
            ...
            <div class="dropdown-menu">
                <div class="user-header">
                    <div class="avatar avatar-sm">
                        <img src="{{asset('img/profiles/avatar-19.png')}}" alt="User Image"
